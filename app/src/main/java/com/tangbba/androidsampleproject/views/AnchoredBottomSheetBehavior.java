...
/**
 * Created by orochi77 on 2018-01-04.
 */

public class AnchoredBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public AnchoredBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        a = context.obtainStyledAttributes(attrs, R.styleable.AnchoredBottomSheetBehavior_Layout);
        mAnchorOffset = (int) a.getDimension(R.styleable.AnchoredBottomSheetBehavior_Layout_behavior_anchorOffset, 0);
        mState = a.getInt(R.styleable.AnchoredBottomSheetBehavior_Layout_behavior_defaultState, mState);
        a.recycle();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mPeekHeightAuto) {
            if (mPeekHeightMin == 0) {
                mPeekHeightMin = parent.getResources().getDimensionPixelSize(android.support.design.R.dimen.design_bottom_sheet_peek_height_min);
            }
     ...
     * @attr ref com.tangbba.androidsampleproject.R.styleable#AnchorBottomSheetBehavior_Layout_behavior_anchorOffset
     */
    ...
    public final void setState(final @State int state) {
        ...
        if (mViewRef == null) {
            ...
            if (state == STATE_COLLAPSED || state == STATE_EXPANDED || state == STATE_ANCHORED || (mHideable && state == STATE_HIDDEN)) {
                mState = state;
            }
            return;
        }
    ...
    /**
     * A utility function to get the {@link AnchoredBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link AnchoredBottomSheetBehavior}.
     * @return The {@link AnchoredBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends  View> AnchoredBottomSheetBehavior<V> from(V view) {
        ...
        return (AnchoredBottomSheetBehavior<V>) behavior;
    }
}
